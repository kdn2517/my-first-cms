...
class Category
{
    ...
    * @return Category|false Объект Category object или false, если запись 
    ...
    * @param string Optional Столбец, по которому сортируются категории(по 
     * умолчанию = "name ASC")
    * @return Array|false Двух элементный массив: results => массив с объектами 
     * Category; totalRows => общее количество категорий
    */
    ...
    /**
    * Вставляем текущий объект Category в базу данных и устанавливаем его 
     * свойство ID.
    */
    ...
    public function insert() 
    {
      ...
      if (!is_null( $this->id)) trigger_error ( "Category::insert(): Attempt to "
              . "insert a Category object that already has its ID property set "
    ...
    */
    ...
    public function update() 
    {
      ...
      if (is_null($this->id)) trigger_error("Category::update(): Attempt to "
              . "update a Category object that does not have its ID property "
              . "set.", E_USER_ERROR);
    ...
    */
    ...
    public function delete() 
    {
      ...
      // У объекта Category  есть ID?
      if (is_null($this->id)) trigger_error("Category::delete(): Attempt to "
              . "delete a Category object that does not have its ID property "
              . "set.", E_USER_ERROR);
